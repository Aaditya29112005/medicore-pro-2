      ...
      <Card className="bg-white shadow-md">
        ...
        <CardContent>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Select Diagnostic Tests</h3>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-lg border border-green-200">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">AI Diagnostic Analysis</h3>
                    <p className="text-sm text-gray-600">Based on collected data and medical patterns</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h4 className="font-medium text-gray-900 mb-2">Primary Diagnosis (85% confidence)</h4>
                    <p className="text-gray-700">Essential Hypertension (I10)</p>
                    <p className="text-sm text-gray-600 mt-1">Based on elevated blood pressure readings and patient history</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <h4 className="font-medium text-blue-900">Medications</h4>
                    ...
                    <div className="p-3 bg-green-50 rounded-lg">
                      <h4 className="font-medium text-green-900">Lifestyle Modifications</h4>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-yellow-50 rounded-lg">
                      <h4 className="font-medium text-yellow-900">Next Appointment</h4>
                      <p className="text-sm text-yellow-800 mt-1">2 weeks - Blood pressure recheck</p>
                    </div>
